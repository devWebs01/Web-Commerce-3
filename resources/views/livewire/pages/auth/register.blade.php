    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="pe-lg-3">
                    <h1 id="font-custom" class="display-3 fw-bold mb-2 mb-md-3">Tampil Beda dengan Koleksi Streetwear
                        Terbaru
                    </h1>
                    <p class="lead mb-4">
                        Kami menjamin ketersediaan produk hingga 99,99%, memastikan kamu dapat menemukan pilihan fashion
                        streetwear idaman tanpa hambatan.
                    </p>
                </div>
                <div class="row">
