    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center">
            <div class="modal-body">
                ...
                <h6 class="text-primary mb-3">{{ auth()->user()->fulladdress }}</h6>
                <h6>
                    Apakah alamat pengiriman ini sudah benar?
                </h6>
            </div>
            <div class="modal-footer d-flex justify-content-around border-0">
                <a class="btn btn-danger" href="{{ route("customer.account", ["user" => auth()->id()]) }}"
                    role="button">
                    Tidak, Ubah Alamat
                </a>

                <form wire:submit="confirmCheckout">
                    <button wire:loading.attr='disable' type="submit" class="btn btn-primary">
