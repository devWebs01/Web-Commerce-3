                            ...
                            @foreach ($orderItems as $item)
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <p>X {{ $item->qty }} item</p>
                                        <h6 class="fw-bold" style="color: #565cff">
                                            Rp.
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="protect_cost">
                                    ...
                                    <p class="fw-bold" style="color: #565cff">
                                        Rp. 3.000
                                    </p>
                                </label>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col text-end fw-bold" style="color: #565cff">
