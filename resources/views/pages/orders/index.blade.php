...
<x-guest-layout>
    ...
    @volt
        <div class="container">
            <div class="row mb-4">
                <div class="col-lg-6">
                    <h2 id="font-custom" class="display-4 fw-bold">Daftar Pesanan</h2>
                </div>
                <div class="col-lg-6 mt-4 mt-lg-0 align-content-center">
                    <p>
                        Di sini kamu dapat melihat daftar pesanan, status pengiriman, dan rincian transaksi kamu.
                        Ini akan memudahkan kamu melacak pembelian kamu sebelumnya.
                    </p>
                </div>
            </div>

            <div class="card rounded-top-5 px-3 mb-3">
                <ul class="nav nav-pills m-3 align-self-center gap-5" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active position-relative" id="pills-process_orders-tab"
                            ...
                            aria-controls="pills-process_orders" aria-selected="true">
                            Masih Proses
                                    ...
                                    <tbody>
                                        @foreach ($process_orders as $no => $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->invoice }}</td>
                                                <td>
                                                    <span class="badge rounded-pill p-2" style="background-color: #635bff">
                                                        {{ __("order_status." . $item->status) }}
                                                    </span>
                                                </td>
                                                <td>{{ "Rp. " . Number::format($item->total_amount, locale: "id") }}</td>
                                                <td>
